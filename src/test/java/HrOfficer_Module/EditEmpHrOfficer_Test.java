...
public class EditEmpHrOfficer_Test {
	public static void main(String[] args) throws Throwable {
		...
		String un=p.getProperty("hrofficeremail");
		String pwd=p.getProperty("hrofficerpwd");
		...
		Thread.sleep(2000);
		WebElement firstname = driver.findElement(By.xpath("(//input[@name='employee_firstname'])[44]"));
		firstname.click();
		Robot r1=new Robot();
		r1.keyPress(KeyEvent.VK_CONTROL);
		r1.keyPress(KeyEvent.VK_A);
		r1.keyRelease(KeyEvent.VK_CONTROL);
		firstname.sendKeys("Radhe");
		Thread.sleep(2000);
		//		JavascriptExecutor j=(JavascriptExecutor)driver;
		//		j.executeScript("window.scrollBy(0,document.body.scrollHeight)", "");
		
		WebElement gss = driver.findElement(By.xpath("(//input[@name='employee_gsis'])[44]"));
		
//		r1.keyPress(KeyEvent.VK_CONTROL);
//		r1.keyPress(KeyEvent.VK_A);
//		r1.keyRelease(KeyEvent.VK_CONTROL);
		gss.sendKeys(Keys.CONTROL+"a");
		gss.sendKeys("1345455");
		Thread.sleep(2000);

		Thread.sleep(3000);
		File f1=new File("./src/test/resources/agile.docx");
		String softfile = f1.getAbsolutePath();
		driver.findElement(By.xpath("(//input[@name='employee_file201'])[23]")).sendKeys(softfile);
		File f2=new File("./src/test/resources/Screenshot (7).png");
		String pic = f2.getAbsolutePath();	
		driver.findElement(By.xpath("(//input[@name='employee_image'])[23]")).sendKeys(pic);
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//button[.='Update'])[22]")).click();
		String result = a.getText();
		a.accept();
		String expectedresult="Upadate sucessfully";
