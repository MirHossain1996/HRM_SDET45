...
public class ListenerImp_Head_Class implements ITestListener{
	ExtentReports report;
	ExtentTest test;

	public void onFinish(ITestContext context) {
		//consolidated the rreport
		report.flush();
	}
	...
	public void onTestFailure(ITestResult result) {
		...
		EventFiringWebDriver edriver= new EventFiringWebDriver(Base_Head_Class.sdriver);
