...
public class AddEmpHrAssistant {

	@FindBy(xpath="//button[@class='btn btn-primary']/preceding::h3/button[@class='btn btn-primary']")
	private WebElement addEmployee;
	
	@FindBy(xpath="//button[.='Save']")
	private WebElement saveEmployee;
	
	public AddEmpHrAssistant(WebDriver driver) {
	...
	public void AddHrAssistantEmployee(ExcelUtility rLib,WebDriver driver,WebDriverUtility wLib,FileUtility fileUt) throws Throwable {
...
//			// driver.findElement(By.name("emplo")).click();
		   ...
		   System.out.println("Hr Assistant employee ::"+data);
		   Thread.sleep(6000);
